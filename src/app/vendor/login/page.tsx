...
export default function VendorLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 flex items-center justify-center px-6 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 right-1/3 w-48 h-48 rounded-full bg-purple-500/10" />
      </div>

      <div className="w-full max-w-md relative z-10">
        {/* Logo */}
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-purple-400 to-purple-700 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-purple-500/30">
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-border p-8">
          <div className="mb-6">
            <h2 className="font-syne font-700 text-xl text-text-1 mb-1">Vendor Sign In</h2>
            <p className="text-text-3 text-xs">Enter your vendor credentials to access your dashboard</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-border rounded-lg text-sm text-text-1 placeholder:text-text-4 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 border border-border rounded-lg text-sm text-text-1 placeholder:text-text-4 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-colors"
          ...
          <div className="mt-6 pt-4 border-t border-border space-y-3">
            ...
            <p className="text-center text-xs text-text-4">
              <Link href="/auth/login" className="hover:text-text-2 transition-colors">
                Customer login →
              </Link>
            </p>
          </div>
